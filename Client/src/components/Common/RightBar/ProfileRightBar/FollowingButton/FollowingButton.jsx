...
const FollowingButton = ({ user }) => {
	...
	const checkConversation = async () => {
		const res = await axios
			.get(
				`https://metabook-by-mahbub-server.herokuapp.com/api/conversation/find/${loggedInUser?._id}/${user?._id}`,
				{
					headers: {
	...
	const createConversation = async () => {
		const res = await axios
			.post(
				`https://metabook-by-mahbub-server.herokuapp.com/api/conversation`,
				{
	...
	const handleFollow = async () => {
		...
		try {
			const url = followed
				? `https://metabook-by-mahbub-server.herokuapp.com/api/users/${user?._id}/unfollow`
				: `https://metabook-by-mahbub-server.herokuapp.com/api/users/${user?._id}/follow`;
